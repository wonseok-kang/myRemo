...
public class lgtvRemoteActivity extends AppCompatActivity {
    ...
    public void irSend(View view){
        switch (view.getId()){
            ...
            case R.id.lgtvpowerOff:
                int lgtvpowerOff[] = {9000,4400, 650,450, 650,450, 700,1550, 650,450, 650,500, 650,450, 650,450, 700,450, 650,1550, 650,1550, 700,450, 650,1550, 650,1550, 700,1550, 650,1550, 650,1550, 650,500, 650,450, 650,500, 650,1550, 650,450, 650,500, 650,450, 650,450, 700,1550, 650,1550, 650,1550, 700,450, 650,1550, 650,1550, 700,1550, 650,1550, 650};  // NEC 20DF10EF
                S_val = lgtvpowerOff;
                break;
