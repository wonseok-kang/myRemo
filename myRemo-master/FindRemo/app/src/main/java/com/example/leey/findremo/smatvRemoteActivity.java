...
public class smatvRemoteActivity extends AppCompatActivity {
    ...
    public void irSend(View view){
        switch (view.getId()){
            ...
            case R.id.stvpowerOff:
                int stvpowerOff[] = {4450,4450, 550,1650, 550,1700, 550,1650, 600,550, 550,550, 550,550, 550,600, 550,550, 550,1650, 600,1650, 550,1700, 550,550, 550,550, 550,600, 550,550, 550,550, 550,550, 600,1650, 550,550, 550,600, 550,550, 550,550, 550,600, 550,550, 550,1650, 550,600, 550,1650, 550,1700, 550,1650, 600,1650, 550,1700, 550,1650, 550};  // SAMSUNG E0E040BF
                S_val = stvpowerOff;
                break;
