...
public class samairRemoteActivity extends AppCompatActivity {
    int S_val[];
  ...
  /*  static {
    ...
    public void irSend(View view){
        switch (view.getId()){
            case R.id.sapowerOn:
                int sapowerOn[] ={450,550, 450,1500, 550,450, 500,450, 500,500, 500,500, 450,500, 550,450, 500,1450, 550,1450, 450,500, 550,1450, 500,1500, 400,1550, 450,1500, 450,550, 500,1450, 550,1450, 450,1500, 500,1450, 550,450, 500,500, 500,450, 550,450, 500,500, 500,500, 400,550, 450,550, 450,550, 450,500, 500,500, 550,450, 500,500, 450,500, 550,450, 500,500, 500,450, 500,500, 500,500, 500,450, 500,500, 500,500, 450,550, 500,450, 450,550, 450,550, 400,550, 500,500, 450,550, 500,450, 550,450, 500,500, 500,1450, 500,1450, 550,1450, 450,1500, 450,3000, 2900};  // SANYO FFFFFFFF
                S_val = sapowerOn;
                break;
