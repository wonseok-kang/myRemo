...
/*        } else if (requestCode == CROP_FROM_CAMERA) {
            ...
            double re =imageAnalysis("image/temp.png", "assets/one.png");
            if(re == 0) {
    ...
    public static double imageAnalysis(String originPath, String tmpPath) {
        Log.d("PATH@",tmpPath);
        Log.d("PATH@", originPath);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_whatisthis:
                ...
                if(path.equals("projector")){
                    Intent intent = new Intent(this, projectorActivity.class);
                    startActivity(intent);
                    break;
                }
                else if(path.equals("samAir")){
                    Intent intent = new Intent(this, samairRemoteActivity.class);
                    startActivity(intent);
                    break;
                }
                else if(path.equals("century")){
                    Intent intent = new Intent(this, centuryRemoteActivity.class);
                    startActivity(intent);
                    break;
                }
                else if(path.equals("lgtv")){
                    Intent intent = new Intent(this, lgtvRemoteActivity.class);
                    startActivity(intent);
                    break;
                }
                    /*{
        ...
        if (requestCode == PICK_FROM_ALBUM) {
            ...
            try {
                if(count ==0) {
                    ...
                    Log.d("h@@", Integer.toString(firstheight));
                    Log.d("h@@", Integer.toString(firstwidth));
                    if(firstheight-firstwidth >=200){
                        path = "samAir";
                    }
                    else if((double)firstwidth / (double)firstheight >=3){
                        path = "projector";
                    }
                    else if((double)firstwidth / (double)firstheight >= 1.3){
                        path = "lgtv";
                    }
                    else{
                        path = "century";
